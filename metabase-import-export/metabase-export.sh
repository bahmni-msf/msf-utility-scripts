...
# Permissions
PGPASSWORD=$PGPASSWORD psql -h "$PGHOST" -U "$PGUSER" -d metabase -c "\COPY (select * from permissions_group) TO 'permissions_group.csv' With CSV DELIMITER',' HEADER;"
PGPASSWORD=$PGPASSWORD psql -h "$PGHOST" -U "$PGUSER" -d metabase -c "\COPY (select * from permissions) TO 'permissions.csv' With CSV DELIMITER',' HEADER;"
PGPASSWORD=$PGPASSWORD psql -h "$PGHOST" -U "$PGUSER" -d metabase -c "\COPY (select * from permissions_group_membership) TO 'permissions_group_membership.csv' With CSV DELIMITER',' HEADER;"
